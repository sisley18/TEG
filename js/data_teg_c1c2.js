        ...
        exercises: {
            ...
            phrasal_verbs: {
                ...
                items: [
                    ...
                    { q: "I can't figure _____ how to solve this complex equation.", correct: "out", explanation: "'Figure out' means to understand or solve." },
                    { q: "He managed to get _____ with a warning instead of a fine.", correct: "away", explanation: "'Get away with' means to escape punishment." },
                    { q: "We shouldn't rule _____ the possibility of a merger.", correct: "out", explanation: "'Rule out' means to exclude." },
                    { q: "The investigation is looking _____ allegations of fraud.", correct: "into", explanation: "'Look into' means to investigate." },
                    { q: "The whole plan hinges _____ his approval.", correct: "on", explanation: "'Hinge on' means to depend entirely on." },
                    { q: "The company plans to branch _____ into software development.", correct: "out", explanation: "'Branch out' means to expand activities." },
                    { q: "He stood _____ for his colleagues during the dispute.", correct: "up", explanation: "'Stand up for' means to defend." },
                    { q: "The sudden noise brought him _____ of his daydream.", correct: "out", explanation: "'Bring out of' means to cause someone to snap out of a state." }
                ]
            }
        }
    },
        ...
        exercises: {
            ...
            phrasal_verbs: {
                ...
                items: [
                    ...
                    { q: "They tried to gloss _____ the serious flaws in the report.", correct: "over", explanation: "'Gloss over' means to treat something as less important than it is." },
                    { q: "The team is currently ironing _____ the final details of the contract.", correct: "out", explanation: "'Iron out' means to resolve minor issues." },
                    { q: "The candidate capitalized _____ his opponent's mistakes.", correct: "on", explanation: "'Capitalize on' means to take advantage of." },
                    { q: "She has been saddled _____ an enormous amount of debt.", correct: "with", explanation: "'Be saddled with' means to be burdened." },
                    { q: "We must guard _____ becoming complacent in our success.", correct: "against", explanation: "'Guard against' means to take precautions." },
                    { q: "The organization is striving to weed _____ inefficiencies.", correct: "out", explanation: "'Weed out' means to remove unwanted elements." },
                    { q: "The debate soon degenerated _____ a shouting match.", correct: "into", explanation: "'Degenerate into' means to deteriorate." },
                    { q: "He managed to scrape _____ the exam despite not studying.", correct: "through", explanation: "'Scrape through' means to succeed with difficulty." }
                ]
            }
        }
    }
